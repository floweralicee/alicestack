...
## CROSS-SKILL: READING FROM lifemaxxing
...
**Write active Villager names and status to `~/.alicestack/game-state.md`** after every session so lifemaxxing can read them.
